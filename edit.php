  ...
  <div class="hero">  
   ...
   <br>
    ...
    <div class="form-check">
         ...
         <?php if (in_array("Balap Mobil", $dataor)) echo "checked";?>>Berenang</label><br>

         <label><input type="checkbox" name="olahraga[]" value="Jogging" 
         <?php if (in_array("Tenis", $dataor)) echo "checked";?>>Jogging</label><br>

         <label><input type="checkbox" name="olahraga[]" value="Tenis Meja" 
         <?php if (in_array("Esport", $dataor)) echo "checked";?>>Tenis Meja</label><br>
    </div>
